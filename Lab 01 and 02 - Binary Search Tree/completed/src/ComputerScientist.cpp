...
ostream& operator<<(ostream& out,
                    const ComputerScientist& ComputerScientist)
{
    // Since operator<< is a friend of the ComputerScientist class, we can
    // access ComputerScientist's members directly.
    out << "(" << ComputerScientist.firstName << " "
        << ComputerScientist.lastName;
...
ComputerScientist::ComputerScientist(const ComputerScientist& rhs)
    : firstName{rhs.firstName}, lastName{rhs.lastName},
      speciality{rhs.speciality}, id{rhs.id}
{
}
...
ComputerScientist& ComputerScientist::
operator=(const ComputerScientist& rhs)
{
